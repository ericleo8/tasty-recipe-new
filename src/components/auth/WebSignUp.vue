    ...
    <div class="container-fluid py-5" style="background-color: #f5f5f5">
        <div style="background-color: #ffffff" class="p-5 m-auto signup-form">
            ...
            <form class="mt-3" @submit.prevent="register">
                <div class="row">
                    ...
                    <div class="col-md-6"><!-- Lastname -->
                        <base-input type="text" identity="lastname" placeholder="Ex: Larsson" label="Lastname" v-model="signupData.lastname">
                        </base-input>
                    </div>
                </div>
                <div class="my-4">
                ...
                <div class="my-4"><!-- Confirm Password -->
                    <base-input type="password" identity="confirmationPassword"
                        v-model="signupData.confirmationPassword" placeholder="Your confirmation password"
                        label="Confirmation Password" @keyInput="confirmationPasswordCheck">
                    </base-input>
                    <p class="text-danger mt-1 fw-medium" style="font-size: 11px"
            ...
            <div class="text-center mt-4">
                <p class="fw-semibold">
                    Already have account?<router-link to="/login" style="color: #4c4ddc"><a
                            class="text-decoration-none"> Login</a></router-link>
                </p>
            </div>
        </div>
    </div>
