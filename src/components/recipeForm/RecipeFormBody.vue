        ...
        <form @submit.prevent="addNewRecipe">
            ...
            <div>
                ...
                <div>
                    ...
                    <!-- Image Start -->
                    <div class="mb-3">
                        <base-input type="file" identity="recipeImage" label="Choose Recipe Photo"
            ...
            <div class="border-top py-3 d-flex my-4 justify-content-end">
                <base-button @clickButton="cancelRecipe" class="cancel-btn px-3 py-2 ms-1">Cancel</base-button>
