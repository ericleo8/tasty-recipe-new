<template>
  <ul class="list-group">
    ...
    <li class="list-group-item">
      ...
      <div class="row">
        <!-- User Recipe Card -->
        <user-recipe-card v-for="recipe in recipes" :key="recipe.id" :recipe="recipe" :buttonName="['Delete', 'Edit']"
          @btnRemove="deleteRecipe(recipe.id)" @btnDetail="editButton(recipe.id)">
